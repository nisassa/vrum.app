                        ...
                        <div className="hidden md:inline flex w-full items-center justify-between">
                            ...
                            <div className="flex flex-row items-center justify-between ml-10">
                                ...
                                <div className="flex">
                                    ...
                                    <Link className=" hover:bg-gray-700 text-white px-3 py-2 rounded-md text-sm font-medium" to="/register">Register</Link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            >
                {(ref) => (
                    <div className="md:hidden" id="mobile-menu">
                        <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 flex flex-col  sm:px-3">
