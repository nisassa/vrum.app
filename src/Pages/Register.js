    ...
    return (
        <div className="container my-4 mx-auto px-4 md:px-12">
            ...
            <div className="flex flex-col md:flex-row items-center w-full mb-8 space-x-4">
                <div className="w-full md:w-1/2 bg-red-100 rounded-lg shadow-md mb-4 md:mb-0">
                    <div className="flex items-center px-12 py-8">
                        <div className="flex flex-col items-start ml-4">
                            ...
                            <Link
                                ...
                                to="/register/provider">Start using the services</Link>
                        </div>
                    </div>
                </div>
                <div className="w-full md:w-1/2 bg-red-100 rounded-lg shadow-md mb-4 md:mb-0">
                    <div className="flex items-center px-12 py-8">
                        <div className="flex flex-col items-start ml-4">
                            ...
                            <Link
                                ...
                                to="/register/provider">Register New Provider</Link>
                        </div>
                    </div>
                </div>
            </div>
